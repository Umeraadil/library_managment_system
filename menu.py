...
while (True):
    ...
    print("WELLCOME TO LIBRARY MANAGEMENT SYSTEM BY UMER AADIL")
    print("********MENU********")
    ...
    if choice == 1:
        ...
        while (True):
            ...
            try:
                ...
                librarian_location = input("Enter your NAME: ")
                # handling ValueError
                try:
    ...
    # Student Choice            
        ...
        try:
            ...
            patron_name = input("Enter STUDENT name: ")
            patron_email = input("Enter STUDENT email: ")

            # handling ValueError
            try:
                patron_id = int(input("Enter STUDENT Id: "))
            except ValueError:
                print("you have not entered a numerical input! \nplease enter a number")
            else:
