...
class Patron:
    ...
    def search(self):
        ...
        if self.patron_search == "s":
            self.librarian_location = input("Enter DEPARTMENT name: ")
            try:
            ...
            self.librarian_location = input("Enter DEPEARTMENT name: ")
            try:
                self.librarian_id = int(input("Enter librarian ID: "))
            except ValueError:
    ...
    def pay_fine(self):
        ...
        self.librarian_location = input("Enter DEPEARTMENT location: ")
        self.librarian_id = input("Enter librarian id: ")
